...
import { NomenclatureVolume } from '@/app/nomenclatures/components/CreateNomenclature/NomenclatureVolume'
...
function CreateNomenclature() {
    ...
    */
	...
	return (
		<div>
			<ActionButton onClick={() => setOpen(true)} icon={AddCircleOutlineIcon} className='mt-5'>Создать номенклатуру</ActionButton>
			<Dialog
				open={open}
							...
							{DAY_KEYS.map((day) => (
								...
								>
									<div style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
										...
										<NomenclatureVolume
											value={formState.settings[day].default_volume}
											onChange={(newVolume) =>
												setFormState((prev) => ({
													...prev,
													settings: {
