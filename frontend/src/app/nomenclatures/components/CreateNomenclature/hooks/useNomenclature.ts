...
export const useNomenclatureForm = () => {
    ...
    const handleTextChange = (field: keyof Omit<ICreateNomenclature, 'settings'>) =>
    ...
    const handleSubmit = async (onSuccess?: () => void) => {
        ...
        try {
            ...
            showNotification(`Ошибка создания: ${error instanceof Error ? error.message : String(error)}`, 'error');
        }
    };
