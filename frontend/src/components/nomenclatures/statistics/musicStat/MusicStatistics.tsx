...
import { MusicStatisticsColumnsTable } from './MusicStatisticsColumnsTable'

export default function MusicStatistics({ id, className }: { id: string; className?: string }) {
	const [statistics, setStatistics] = useState<INomenclatureMusicStatistics[]>([])
	...
	const table = useReactTable<INomenclatureMusicStatistics>({
		data: statistics,
		columns: MusicStatisticsColumnsTable,
