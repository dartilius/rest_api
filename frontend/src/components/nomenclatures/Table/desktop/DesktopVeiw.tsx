...
import { nomenclaturesColumnsTable } from './nomenclaturesColumnsTable'

interface IProps {
	data: INomenclaturesListResponse['results']
	countNomenclatures: number
}

export default function DesktopNomenclaturesVeiw({ countNomenclatures, data }: IProps) {
