...
export default function CustomPaginationMobile({
	...
	return (
		<div className='flex items-center justify-evenly bg-[var(--info)] text-white hover:bg-blue-700 shadow-lg hover:shadow-xl w-fit min-w-[240px] gap-2 min-h-[48px] h-fit rounded-full'>
