...
TYPE_FL = {"IP": "ИП", "FL": "ФЛ", "SE": "Самозанятый"}
...
class Counterparty(APIBaseObjectModel):
    ...
    inn = models.CharField(
        max_length=64, blank=True, null=True, verbose_name="ИНН", default=""
    )

    first_name = models.CharField(
        max_length=64, blank=True, null=False, verbose_name="Имя", default=""
    )

    middle_name = models.CharField(
        max_length=64, blank=True, null=False, verbose_name="Отчество", default=""
    )

    last_name = models.CharField(
        max_length=64, blank=True, null=False, verbose_name="Фамилия", default=""
    )

    description = models.CharField(
        max_length=256, blank=True, null=True, default="", verbose_name="Описание"
    )

    keyword = models.CharField(
        max_length=256, blank=True, null=True, default="", verbose_name="Ключевое слово"
    )

    additional_name = models.CharField(
        max_length=64, blank=True, null=True, default="", verbose_name="Доп. название"
    )
