    ...
    operations = [
        migrations.CreateModel(
            ...
            options={
                ...
                'db_table': 'ad_stat',
                'engine': clickhouse_backend.models.MergeTree(order_by=('client', 'played', 'id'), partition_by=clickhouse_backend.models.toYYYYMM(models.F('played')), storage_policy='statistics_tiered'),
            },
            managers=[
