    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('file', clickhouse_backend.models.StringField(max_length=288, verbose_name='Идентификатор файла')),
                ('client', clickhouse_backend.models.StringField(max_length=288, verbose_name='Идентификатор номенклатуры')),
