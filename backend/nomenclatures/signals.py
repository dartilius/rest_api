...
def handle_nomenclature_post_save(sender, instance, created, **kwargs):
    ...
    relevant_fields = [
        'name', 'code1c', 'id_rasb', 'description',
        'contentType', 'brand', 'legalEntity', 'typeOfPlace',
        'responsible_ad', 'responsible_placement_marketing',
    ...
    if should_update:
        transaction.on_commit(
            lambda: instance.update_search_vector()
        )
        transaction.on_commit(
