    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('admin', 'Сотрудник ТО'), ('manager', 'Менеджер'), ('superuser', 'Суперпользователь'), ('auth', 'Аутентифицированный пользователь')], max_length=32, verbose_name='Роль')),
